...
Więcej informacji o tym, co można robić z domenami dla poszczególnych typów oferty, zawiera Microsoft 365 i Office 365 [opisu usługi platformy](/office365/servicedescriptions/office-365-platform-service-description/domains).
...
|Rekord SRV (rekord usługi)  <br/> |Używany przez Skype dla firm online i Exchange Online w celu koordynowania przepływu informacji między usługi firmy Microsoft. Rekordy SRV są na przykład wymagane do wyświetlania informacji o obecności w aplikacji Outlook Web App oraz do korzystania z usługi Skype dla firm Online, programu Skype lub innych narzędzi do wymiany wiadomości błyskawicznych z osobami w innych firmach.  <br/> |
...
Rekordy DNS są jak bazy danych z informacjami o Twojej domenie. Rekordy i ich wartości są przechowywane w tak zwanym pliku strefy, który zawiera listę wszystkich rekordów dla Twojej domeny i ich wartości. Rejestratorzy domen i inne firmy zajmujące się hostingiem DNS oferują w swoich witrynach internetowych interfejs użytkownika, który umożliwia edytowanie rekordów w pliku strefy danej domeny. W tym miejscu możesz zaktualizować rekord MX dla swojej domeny, aby wysyłać wiadomości e-mail do Microsoft 365.
  
 *Gdy w następnym kroku Microsoft 365 e-mail na Microsoft 365 rekord MX domeny, WSZYSTKIE wiadomości e-mail wysyłane do tej domeny zaczną przychodzić do Microsoft 365.*  Jeśli inne osoby używają Twojej domeny do korzystania z poczty e-mail, musisz Microsoft 365 skrzynki pocztowe dla tych osób. 
...
::: moniker range="o365-worldwide"
## <a name="why-add-a-domain-in-microsoft-365"></a>Dlaczego warto dodać domenę w Microsoft 365?


Dodanie domeny niestandardowej, na przykład fourthcoffee.com, do Microsoft 365 umożliwia korzystanie z krótszych i bardziej znanych adresów e-mail oraz identyfikatorów użytkowników w usłudze. Masz [domenę do](../setup/domains-faq.yml) użycia podczas zakładania konta Microsoft 365, ale zawiera ona "onmicrosoft.com". Wiele osób woli dodać swoją domenę w organizacji lub firmie, jeśli zamierza używać poczty e-mail Microsoft 365 e-mail. 
  
> [!NOTE]
> Jeśli chcesz tylko pobrać aplikacje firmy Microsoft, takie jak Outlook lub Word, i korzystać z nich, nie musisz dodawać domeny: instalowanie programu Office na [komputerze PC lub Mac](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658). 
  
Nazwy domeny możesz używać w programie Microsoft 365 e-mail, publicznej witrynie internetowej i adresie wiadomości błyskawicznych.
  
- **Adres e-mail.** Nazwa domeny umożliwia dostosowanie adresu e-mail, dzięki czemu można używać krótszego, łatwiejszego do zapamiętania adresu, niż [początkowy adres e-mail w domenie onmicrosoft.com](../setup/domains-faq.yml) dostarczony z Twoim kontem. Dlatego zamiast joe@contoso.onmicrosoft.com adres e-mail (który jest również kontem służbowym, którego używasz do logowania się do Microsoft 365) może zostać joe@contoso.com. 
    
- **Witryna internetowa:** Jeśli masz subskrypcję usługi Microsoft 365, która obejmuje publiczną witrynę sieci Web usługi SharePoint Online (nie jest już dostępna w sprzedaży), jej adres początkowy ma taki adres początkowy: contoso-public.sharepoint.com. Jeśli konfigurujesz witrynę internetową dla swojej firmy, możesz zmienić adres tej witryny za pomocą niestandardowej nazwy domeny na adres typu www.contoso.com. 
...
## <a name="the-dns-records-required-for-microsoft-365"></a>Rekordy DNS wymagane dla Microsoft 365

Istnieje kilka rekordów DNS wymaganych do Microsoft 365 z domeną. Oprócz rekordu MX domeny, tak aby wiadomości e-mail były wysyłane do usługi Microsoft 365, istnieją rekordy pomagające w zadaniach, takich jak upewniowanie się, że program Outlook może automatycznie nawiązać połączenie z odpowiednim serwerem Exchange, skonfigurowanie wiadomości błyskawicznych i zapobieganie spamowi poczty e-mail.
  
Możesz [znaleźć listę wartości](information-for-dns-records.md) potrzebnych do skonfigurowania domeny. Są one dołączone <a href="https://go.microsoft.com/fwlink/p/?linkid=834818" target="_blank">bezpośrednio centrum administracyjne platformy Microsoft 365.</a> 
  
Jeśli natomiast planujesz wdrożenie, warto przejrzeć listę wszystkich rekordów DNS wymaganych dla systemu Microsoft 365, ich funkcji i przykładowych wartości. Zobacz Zewnętrzne [rekordy systemu nazw domen (External Domain Name System) dla Microsoft 365](../../enterprise/external-domain-name-system-records.md).
...
- Dowiedz się[, dlaczego musisz wykonać kroki kreatora](../setup/add-domain.md), aby można było używać domeny z Microsoft 365.
