...
## <a name="set-up-microsoft-365-for-business"></a>Konfigurowanie Microsoft 365 dla firm
...
2. Na stronie **Instalowanie aplikacji Office** możesz opcjonalnie zainstalować aplikacje na własnym komputerze.
...
4. Wykonaj kroki tworzenia [rekordów DNS u dowolnego dostawcy hostingu DNS dla Office 365](/office365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider), który weryfikuje, czy jesteś właścicielem domeny. Jeśli znasz hosta domeny, zobacz również [Dodawanie domeny do Microsoft 365](/microsoft-365/admin/setup/add-domain).
...
2. Wykonaj kroki zakupu nowej domeny i wprowadź nazwę domeny, która ma być używana (na przykład contoso.com). Po zakończeniu kupowania domeny możesz [dodawać użytkowników i licencje](../add-users/add-users.md) oraz instalować aplikacje Office w centrum administracyjnym.

## <a name="finish-setting-up"></a>Zakończ konfigurowanie

Wykonaj poniższe kroki, aby skonfigurować Outlook, Teams, OneDrive i witrynę internetową.
...
Możesz również użyć <a href="https://go.microsoft.com/fwlink/p/?linkid=2059104" target="_blank">Exchange centrum administracyjnego</a>, aby zaimportować wiadomości e-mail wszystkich użytkowników. Aby uzyskać więcej informacji, zobacz [migrowanie wielu kont e-mail](/Exchange/mailbox-migration/mailbox-migration).

## <a name="set-up-microsoft-teams-and-onedrive-for-business"></a>Konfigurowanie Microsoft Teams i OneDrive dla firm

Wybierz ikonę chmury OneDrive na pasku zadań i wykonaj kroki, aby przenieść pliki do nowego folderu OneDrive dla Firm. Wybierz pozycję **Dalej**, aby skonfigurować Microsoft Teams.

1. Otwórz Microsoft Teams, wybierz ikonę profilu, a następnie **dodaj konto służbowe**. Wykonaj kroki dodawania nowego konta do Teams.

## <a name="use-a-public-website"></a>Korzystanie z publicznej witryny internetowej

Microsoft 365 nie zawiera publicznej witryny internetowej twojej firmy. Jeśli chcesz go skonfigurować, rozważ użycie partnera firmy Microsoft, takiego jak GoDaddy lub WIX.
...
Po skonfigurowaniu organizacji możesz zaprosić innych użytkowników do dołączenia do Microsoft 365 subskrypcji biznesowej. Uzyskają dostęp do wszystkich funkcji subskrypcji.
...
- [Zaakceptuj zaproszenie e-mail przy użyciu Outlook, Yahoo, Gmail lub innego konta (użytkownik)](../simplified-signup/user-invite-msa-nodomain-join.md)
