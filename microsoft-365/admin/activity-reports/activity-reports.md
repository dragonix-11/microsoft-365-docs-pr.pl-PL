---
title: centrum administracyjne platformy Microsoft 365 aktywności
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
|[Aktywność użytkowników aplikacji Microsoft Teams](microsoft-teams-user-activity-preview.md)|Tak|Tak|Tak|Tak|N/A[^2]|
|[Użycie urządzeń z aplikacją Microsoft Teams](microsoft-teams-device-usage-preview.md)|Tak|Tak|Tak|Tak|N/A[^2]|
|[Aktywność usługi Yammer](yammer-activity-report-ww.md)|Tak|Tak|N/A[^2]|N/A[^2]|N/A[^2]|
|[Użycie urządzeń w usłudze Yammer](yammer-device-usage-report-ww.md)|Tak|Tak|N/A[^2]|N/A[^2]|N/A[^2]|
|[Raport aktywności grup usługi Yammer](yammer-groups-activity-report-ww.md)|Tak|Tak|N/A[^2]|N/A[^2]|N/A[^2]|
|[Aktywność formularzy](forms-activity-ww.md)|Tak|Tak|Nie[^1]|Nie[^1]|Nie[^1]|
|[Aktywność klientów usługi Dynamics 365 Customer Voice](forms-pro-activity-ww.md)|Tak|Tak|N/A[^2]|N/A[^2]|N/A[^2]|
...
Nie można wygenerować raportu, w którym wprowadza się konto użytkownika, a następnie jest generowana lista usług, z których korzysta i ile.
