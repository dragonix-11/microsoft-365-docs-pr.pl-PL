...
### <a name="step-5-configure-aip-apps-on-windows"></a>Krok 5. Konfigurowanie aplikacji usługi AIP w systemie Windows
...
1. Sprawdź, czy usługa jest teraz zainstalowana przy użyciu usług **narzędzi** > **administracyjnych**.
