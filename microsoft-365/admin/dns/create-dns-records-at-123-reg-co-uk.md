...
5. W polu **Typ** nowego rekordu wybierz z listy rozwijanej pozycję **TXT/SPF** , a następnie wpisz lub skopiuj i wklej inne wartości z poniższej tabeli.
    ...
    |---|---|---|
    |@|TXT/SPF|MS=*msXXXXXXXX* <br/> **Uwaga:** To jest przykład. Użyj tutaj swojej **konkretnej** wartości Miejsce docelowe lub punkt na adres z tabeli. [Jak to znaleźć?](../get-help-with-domains/information-for-dns-records.md)|
...
5. W polu **Typ** nowego rekordu wybierz z listy rozwijanej pozycję **TXT/SPF** , a następnie wpisz lub skopiuj i wklej inne wartości z poniższej tabeli.
    ...
    |Hostname (Nazwa hosta)|Type (Typ)|Destination TXT/SPF (TXT/SPF miejsca docelowego)|
    |---|---|---|
    |@|TXT/SPF|v=spf1 include:spf.protection.outlook.com -all <br/> **Uwaga:** Zalecamy skopiowanie i wklejenie tego wpisu, aby wszystkie odstępy pozostawały poprawne.|
...
### <a name="add-the-two-required-cname-records-for-skype-for-business"></a>Dodawanie dwóch rekordów CNAME wymaganych dla Skype dla firm
