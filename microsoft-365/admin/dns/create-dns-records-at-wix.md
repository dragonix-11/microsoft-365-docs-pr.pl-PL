...
4. W polach nowego rekordu wpisz lub skopiuj i wklej wartości z poniższej tabeli.
   ...
   |Host Name|Wartość TXT|Czas wygaśnięcia|
   |---|---|---|
   |Automatycznie wypełniane (pozostaw puste)|MS=*msXXXXXXXX* <br/> **Uwaga:** To jest przykład. Użyj tutaj swojej **konkretnej** wartości Miejsce docelowe lub punkt na adres z tabeli. [Jak to znaleźć?](../get-help-with-domains/information-for-dns-records.md)|1 godzina|
...
4. W polach nowego rekordu wpisz lub skopiuj i wklej wartości z poniższej tabeli:
   ...
   |Host Name|Value|Czas wygaśnięcia|
   |---|---|---|
...
4. W polach nowego rekordu wpisz lub skopiuj i wklej wartości z poniższej tabeli:
   ...
   |Host Name|Value|Czas wygaśnięcia|
   |---|---|---|
   |[pozostaw to pole puste]|v=spf1 include:spf.protection.outlook.com -all <br/> **Uwaga:** Zalecamy skopiowanie i wklejenie tego wpisu, aby wszystkie odstępy pozostawały poprawne.|1 godzina|
