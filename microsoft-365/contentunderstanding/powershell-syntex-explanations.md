---
title: Praca z objaśnieniami modelu dokumentu w programie PowerShell
ms.author: jaeccles
author: jameseccles
...
description: Dowiedz się więcej o pracy z SharePoint Syntex wyjaśnieniem modelu w programie PowerShell.
ms.openlocfilehash: 06f0eb7314b85f9463689fea32667666e5e167fd
ms.sourcegitcommit: d37fce3b708ea5232b4102fd0e693f4bf17a8948
ms.translationtype: MT
ms.contentlocale: pl-PL
ms.lasthandoff: 01/21/2022
ms.locfileid: "63013364"
---
# <a name="work-with-document-understanding-model-explanations-in-powershell"></a>Praca z objaśnieniami modelu dokumentu w programie PowerShell
...
Niestandardowe szablony objaśnień są przechowywane na liście w centrum zawartości. Ponieważ objaśnienia te są przechowywane jako elementy listy, można z nimi korzystać za pomocą programu PowerShell.

## <a name="list-saved-explanations"></a>Lista zapisanych objaśnień
...
## <a name="create-a-phrase-list-explanation"></a>Objaśnienie tworzenia listy fraz

W tym przykładzie pokazano, jak utworzyć niestandardowy szablon objaśnienia listy fraz.
...
## <a name="create-a-regular-expression-explanation"></a>Tworzenie objaśnienia wyrażeń regularnych

W tym przykładzie pokazano, jak utworzyć niestandardowy szablon objaśnień wyrażeń regularnych.
...
## <a name="create-a-phrase-list-explanation-based-on-a-term-set"></a>Tworzenie objaśnienia listy fraz na podstawie zestawu terminów

W tym przykładzie pokazano, jak utworzyć szablon objaśnienia niestandardowej listy fraz, korzystając z wartości z zestawu terminów. Obejmuje to preferowane nazwy terminów i wszelkie synonimy.
