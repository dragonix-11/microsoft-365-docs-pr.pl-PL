...
description: Zabezpieczenia w Office 365, od usługi EOP do programu Defender Office 365 planów 1 i 2, konfiguracji standardowej i ścisłej konfiguracji zabezpieczeń i nie tylko. Dowiedz się, co masz, i dowiedz się, jak zabezpieczyć swoje właściwości.
ms.technology: mdo
...
Używanie [funkcji ataków w programie Microsoft Defender Office 365](attack-simulator.md)
