...
|Ochrona punktu końcowego w usłudze Microsoft Defender|Urządzenia muszą być podłączone do usługi Defender for Endpoint. Zobacz następujące artykuły: <br/>- [Minimalne wymagania programu Microsoft Defender dla punktu końcowego](minimum-requirements.md)<br/>- [Urządzenia na urządzeniach i konfigurowanie programu Microsoft Defender na temat możliwości punktu końcowego](onboard-configure.md)<br/>- [Wdowe Windows do usługi Defender for Endpoint](configure-server-endpoints.md)<br/>- [Nowe Windows Server 2012 R2 i 2016 w nowoczesnym, ujednoliconym rozwiązaniu (wersja Preview)](configure-server-endpoints.md#new-windows-server-2012-r2-and-2016-functionality-in-the-modern-unified-solution-preview) |
