---
title: Dołączanie Windows urządzeń z wieloma sesjami w usłudze Azure Virtual Desktop
description: Przeczytaj więcej w tym artykule na temat dołączania Windows urządzeń z wieloma sesjami w usłudze Azure Virtual Desktop
...
---
# <a name="onboard-windows-multi-session-devices-in-azure-virtual-desktop"></a>Dołączanie Windows urządzeń z wieloma sesjami w usłudze Azure Virtual Desktop

6 minut do odczytu

**Dotyczy:**
- [Ochrona punktu końcowego w usłudze Microsoft Defender (plan 2)](https://go.microsoft.com/fwlink/p/?linkid=2154037) 
- Windows wielu sesjach uruchomionych w usłudze Azure Virtual Desktop (AVD)
...
Jeśli planujesz zarządzanie maszynami przy użyciu narzędzia do zarządzania, możesz dołączyć urządzenia z Microsoft Endpoint Configuration Manager.

Aby uzyskać więcej informacji, zobacz [Dołączanie urządzeń Windows przy użyciu Configuration Manager](configure-endpoints-sccm.md).

> [!WARNING]
> Jeśli planujesz używać [odwołania do reguł zmniejszania obszaru ataków](attack-surface-reduction-rules-reference.md), pamiętaj, że reguła "[Blokuj tworzenie procesów pochodzących z poleceń PSExec i WMI](attack-surface-reduction-rules-reference.md#block-process-creations-originating-from-psexec-and-wmi-commands)" nie powinna być używana, ponieważ ta reguła jest niezgodna z zarządzaniem za pośrednictwem Microsoft Endpoint Configuration Manager. Reguła blokuje polecenia usługi WMI używane przez klienta Configuration Manager do poprawnego działania.
...
Uwaga dotycząca licencjonowania: w przypadku korzystania z Windows Enterprise wielu sesji, w zależności od wymagań, możesz wybrać licencję wszystkich użytkowników za pośrednictwem Ochrona punktu końcowego w usłudze Microsoft Defender (na użytkownika), Windows Enterprise E5 , Microsoft 365 Zabezpieczenia, Microsoft 365 E5 lub mieć licencję maszyny wirtualnej za pośrednictwem Microsoft Defender dla Chmury.
...
Filtrowanie sieci Web w Windows 10 wielu sesjach jest obsługiwane tylko Microsoft Edge.
