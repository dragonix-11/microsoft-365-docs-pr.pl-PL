---
title: Ustawianie preferencji programu Microsoft Defender dla punktu końcowego w systemie Linux
ms.reviewer: ''
description: W tym artykule opisano sposób konfigurowania programu Microsoft Defender dla punktu końcowego w systemie Linux w przedsiębiorstwach.
...
ms.locfileid: "63015939"
---
# <a name="set-preferences-for-microsoft-defender-for-endpoint-on-linux"></a>Ustawianie preferencji programu Microsoft Defender dla punktu końcowego w systemie Linux
...
|**Typ danych**|Ciąg|
|**Dopuszczalne wartości**|wyłączona <p> włączony (domyślnie)|
...
|**Typ danych**|Wartość logiczna|
|**Dopuszczalne wartości**|true (domyślnie) <p> fałsz|
|**Komentarze**|Dostępny w programie Microsoft Defender dla punktu końcowego w wersji 101.45.00 lub wyższej.|
|||
