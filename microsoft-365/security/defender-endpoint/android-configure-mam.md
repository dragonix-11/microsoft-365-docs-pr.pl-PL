...
- **Sprawdzanie, czy jest włączony program Microsoft Defender Endpoint-Intune łącznika**
  ...
  ![Obraz łącznika programu Defender Endpoint-Intune Intune](images/validate-intune-connector.png)
...
- **Włączanie programu Microsoft Defender dla punktu końcowego w łączniku systemu Android dla zasad ochrony aplikacji (APP)**
  ...
  a. Przejdź do **strony Administracja dzierżawą, > łączniki i tokeny > programie Microsoft Defender for Endpoint**.
