...
description: Dowiedz się więcej o możliwościach blokowania zachowania i blokowania treści na stronie Ochrona punktu końcowego w usłudze Microsoft Defender
keywords: Ochrona punktu końcowego w usłudze Microsoft Defender, EDR w trybie blokowania, blokowanie trybu pasywnego
...
:::image type="content" source="images/mdatp-next-gen-EDR-behavblockcontain.png" alt-text="Blokowanie i blokowanie zachowania w portalu AtP usługi Microsoft Defender" lightbox="images/mdatp-next-gen-EDR-behavblockcontain.png":::
...
:::image type="content" source="images/blocked-behav-alert.png" alt-text="Strona Alerty z alertem w przypadku blokowania i blokowania zachowania" lightbox="images/blocked-behav-alert.png":::
...
Modele nauki dotyczące urządzeń oparte na zachowaniu w programie Defender dla punktu końcowego, które zatrzymały technikę atakującego w dwóch punktach w łańcuchu ataków:

- Pierwsza warstwa ochrony wykryła exploit behavior. Klasyfikatory oparte na nauczaniu urządzeń w chmurze prawidłowo zidentyfikowały zagrożenie, tak jak i natychmiast poinstruowały urządzenie klienckie, aby zablokowało atak.
...
:::image type="content" source="images/behavblockcontain-initialaccessalert.png" alt-text="Alert dostępu początkowego w Microsoft 365 Defender sieci" lightbox="images/behavblockcontain-initialaccessalert.png":::

W tym przykładzie pokazano, jak modele uczenia oparte na zachowaniu w chmurze dodają nowe warstwy ochrony przed atakami nawet po ich uruchomieniu.
...
:::image type="content" source="images/NTLMalertjuicypotato.png" alt-text="Alert NTLM dla złośliwego oprogramowania z kartofelami" lightbox="images/NTLMalertjuicypotato.png":::
