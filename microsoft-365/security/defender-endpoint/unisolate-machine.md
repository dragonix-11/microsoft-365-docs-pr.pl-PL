---
title: Urządzenie zwalniające z interfejsu API izolacji
description: Użyj tego interfejsu API, aby utworzyć wywołania związane z zwolnieniem urządzenia z izolacji.
...
---
# <a name="release-device-from-isolation-api"></a>Urządzenie zwalniające z interfejsu API izolacji
...
W przypadku wysłania wielu wywołań interfejsu API w celu usunięcia izolacji tego samego urządzenia zwracana jest "oczekująca akcja komputerowa" lub HTTP 400 z komunikatem "Akcja jest już w toku".
...
Aby odizolować urządzenie, zobacz [Wyodrębnij urządzenie](isolate-machine.md).
