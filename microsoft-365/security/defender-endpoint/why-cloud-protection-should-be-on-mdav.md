...
description: Sprawdź, dlaczego ochrona chmury powinna być włączona dla Program antywirusowy Microsoft Defender. Pomaga ona w wielu funkcjach zabezpieczeń w Ochrona punktu końcowego w usłudze Microsoft Defender pracy
...
Program antywirusowy Microsoft Defender ochrony chmury pomaga chronić przed złośliwym oprogramowaniem w punktach końcowych i w całej sieci. Zalecamy, aby ochrona chmury została włączona, ponieważ pewne funkcje i możliwości zabezpieczeń w usłudze Ochrona punktu końcowego w usłudze Microsoft Defender działają tylko wtedy, gdy jest włączona ochrona w chmurze. 

[![alt-text="Diagram przedstawiający rzeczy, które zależą od ochrony chmury](images/mde-cloud-protection.png#lightbox)](enable-cloud-protection-microsoft-defender-antivirus.md)
...
1. **[Włączanie ochrony w chmurze](enable-cloud-protection-microsoft-defender-antivirus.md)**. Ochronę chmury można włączyć za pomocą poleceń cmdlet programu Microsoft Endpoint Manager (które teraz zawierają Microsoft Endpoint Configuration Manager i Microsoft Intune), zasady grupy lub PowerShell.
