...
description: Opis sposobu wdrażania Ochrona punktu końcowego w usłudze Microsoft Defender na Android przy użyciu Microsoft Intune
...
Dowiedz się, jak wdrożyć usługę Defender for Endpoint na Android na Intune — Portal firmy zarejestrowanych urządzeniach. Aby uzyskać więcej informacji na temat rejestracji urządzeń Intune, zobacz [Rejestrowanie urządzenia](/mem/intune/user-help/enroll-device-android-company-portal).

> [!NOTE]
> **Usługa Defender for Endpoint w Android jest teraz dostępna w [Google Play](https://play.google.com/store/apps/details?id=com.microsoft.scmx)**
>
> Możesz nawiązać połączenie z Google Play z Intune, aby wdrożyć aplikację Defender for Endpoint w trybach administratora urządzeń i Android Enterprise rejestracji.
>
> Aktualizacje aplikacji są automatyczne za pośrednictwem Google Play.
...
Dowiedz się, jak wdrożyć usługę Defender for Endpoint na Android na urządzeniach zarejestrowanych przez administratora urządzeń Intune — Portal firmy.

### <a name="add-as-android-store-app"></a>Dodaj jako aplikację ze sklepu Android

1. W [centrum administracyjnym Microsoft Endpoint Manager](https://go.microsoft.com/fwlink/?linkid=2109431) przejdź do pozycji **Aplikacje** \> **Android Aplikacje** \> **Dodaj \> aplikację ze sklepu Android store** i wybierz **pozycję Wybierz**.

   :::image type="content" source="images/mda-addandroidstoreapp.png" alt-text="Okienko Dodawanie aplikacji magazynu Android w portalu centrum administracyjnego Microsoft Endpoint Manager"  lightbox="images/mda-addandroidstoreapp.png":::
...
2. Na stronie **Dodawanie aplikacji** i w sekcji *Informacje o aplikacji* wprowadź:
   ...
   - **Adres URL sklepu z aplikacjami** jako https://play.google.com/store/apps/details?id=com.microsoft.scmx (adres URL Sklep Google Play aplikacji defender for Endpoint)
...
3. W sekcji *Przypisania* przejdź do sekcji **Wymagane** i wybierz pozycję **Dodaj grupę.** Następnie możesz wybrać grupy użytkowników, które chcesz skierować do usługi Defender for Endpoint w aplikacji Android. Wybierz **pozycję Wybierz** , a następnie **pozycję Dalej**.
...
1. Po zainstalowaniu usługi Defender for Endpoint na Android na urządzeniu zostanie wyświetlona ikona aplikacji.
...
2. Naciśnij ikonę aplikacji Ochrona punktu końcowego w usłudze Microsoft Defender i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie, aby ukończyć dołączanie aplikacji. Szczegóły obejmują akceptację przez użytkownika końcowego uprawnień Android wymaganych przez usługę Defender dla punktu końcowego w Android.
...
## <a name="deploy-on-android-enterprise-enrolled-devices"></a>Wdrażanie na Android Enterprise zarejestrowanych urządzeniach

Usługa Defender for Endpoint w Android obsługuje Android Enterprise zarejestrowanych urządzeń.
...
## <a name="add-microsoft-defender-for-endpoint-on-android-as-a-managed-google-play-app"></a>Dodawanie Ochrona punktu końcowego w usłudze Microsoft Defender w Android jako aplikacji Google Play zarządzanej

Wykonaj poniższe kroki, aby dodać aplikację Ochrona punktu końcowego w usłudze Microsoft Defender do zarządzanego Google Play.

1. W [centrum administracyjnym Microsoft Endpoint Manager](https://go.microsoft.com/fwlink/?linkid=2109431) przejdź do pozycji **Aplikacje** \> **Android Aplikacje** \> **Dodaj** i wybierz pozycję **Zarządzana aplikacja Google Play**.
...
2. Na stronie Google Play zarządzanej, która zostanie załadowana później, przejdź do pola wyszukiwania i wprowadź wartość `Microsoft Defender`. Wyszukiwanie powinno wyświetlać aplikację Ochrona punktu końcowego w usłudze Microsoft Defender w Google Play zarządzanym. Kliknij aplikację Ochrona punktu końcowego w usłudze Microsoft Defender z wyniku wyszukiwania Aplikacje.

    :::image type="content" source="images/0f79cb37900b57c3e2bb0effad1c19cb.png" alt-text="Strona Google Play zarządzana w portalu centrum administracyjnego Microsoft Endpoint Manager" lightbox="images/0f79cb37900b57c3e2bb0effad1c19cb.png":::
...
3. Na stronie Opis aplikacji, która pojawi się w następnej kolejności, powinny być widoczne szczegóły aplikacji w usłudze Defender for Endpoint. Przejrzyj informacje na stronie, a następnie wybierz pozycję **Zatwierdź**.
    ...
    > :::image type="content" source="images/07e6d4119f265037e3b80a20a73b856f.png" alt-text="Strona Google Play zarządzanego w portalu centrum administracyjnego Microsoft Endpoint Manager" lightbox="images/07e6d4119f265037e3b80a20a73b856f.png":::
...
5. Zostanie wyświetlona strona Ustawienia zatwierdzania. Strona potwierdza preferencję obsługi nowych uprawnień aplikacji, o które może poprosić usługa Defender for Endpoint w Android. Przejrzyj wybrane opcje i wybierz preferowaną opcję. Wybierz pozycję **Gotowe**.

    Domyślnie Google Play zarządzane wybiera pozycję **Zachowaj zatwierdzenie, gdy aplikacja żąda nowych uprawnień**.
...
7. Synchronizacja zakończy się za kilka minut.
    ...
    :::image type="content" source="images/9fc07ffc150171f169dc6e57fe6f1c74.png" alt-text="Okienko stanu synchronizacji aplikacji na stronie aplikacji Android w portalu usługi Microsoft Defender 365"  lightbox="images/9fc07ffc150171f169dc6e57fe6f1c74.png":::

8. Wybierz przycisk **Odśwież** na ekranie aplikacji Android, a Ochrona punktu końcowego w usłudze Microsoft Defender powinny być widoczne na liście aplikacji.
...
1. Potwierdź stan instalacji Ochrona punktu końcowego w usłudze Microsoft Defender na Android, klikając pozycję **Stan instalacji urządzenia**. Sprawdź, czy urządzenie jest wyświetlane tutaj.
...
4. Na tym etapie urządzenie zostało pomyślnie dołączone do usługi Defender for Endpoint w Android. Możesz to sprawdzić w [portalu Microsoft 365 Defender](https://security.microsoft.com), przechodząc do strony **Spis urządzeń**.
...
## <a name="set-up-microsoft-defender-in-personal-profile-on-android-enterprise-in-byod-mode"></a>Konfigurowanie usługi Microsoft Defender w profilu osobistym na Android Enterprise w trybie BYOD

> [!NOTE]
> Obsługa usługi Microsoft Defender w profilu osobistym w Android Enterprise (AE) w trybie "Przynieś własne urządzenie" (BYOD) jest teraz dostępna w publicznej wersji zapoznawczej. Poniższe informacje dotyczą wstępnie wydanego produktu, który może zostać znacząco zmodyfikowany przed jego komercyjną premierą. Firma Microsoft nie udziela żadnych gwarancji, wyraźnych ani dorozumianych, w odniesieniu do podanych tutaj informacji.

Dzięki obsłudze usługi Microsoft Defender w Android profilach osobistych urządzenia użytkowników mogą być chronione przed atakami wyłudzania informacji i złośliwego oprogramowania w profilu osobistym, które mogą potencjalnie naruszyć bezpieczeństwo zasobów firmowych w profilu służbowym.

### <a name="set-up-microsoft-defender-in-personal-profile"></a>Konfigurowanie usługi Microsoft Defender w profilu osobistym
...
1. Wprowadź **nazwę** i **opis** , aby jednoznacznie zidentyfikować zasady konfiguracji. Wybierz platformę jako **"Android Enterprise",** typ profilu **jako "Tylko profil służbowy należący do użytkownika",** a aplikację docelową **jako "Microsoft Defender"**.
...
### <a name="to-complete-onboarding-a-device"></a>Aby ukończyć dołączanie urządzenia

1. Zainstaluj aplikację Microsoft Defender w profilu osobistym przy użyciu osobistego konta Google Play sklepu.
