...
:::image type="content" source="../media/security/security-for-bdms-overview.png" alt-text="Procedura ograniczania ryzyka dla twojej firmy" lightbox="../media/security/security-for-bdms-overview.png":::
...
:::image type="content" source="../media/m365-security-bdm-illustrations-privileged-accounts.png" alt-text="Zalecane funkcje ochrony kont z uprawnieniami" lightbox="../media/m365-security-bdm-illustrations-privileged-accounts.png":::
...
|**Ochrona poczty e-mail przed atakami ukierunkowanych wyłudzania informacji**. Jeśli skonfigurowano co najmniej jedną domenę niestandardową dla środowiska Office 365 lub Microsoft 365, możesz skonfigurować ukierunkowaną ochronę przed wyłudzaniem informacji. Ochrona przed wyłudzaniem informacji, część Ochrona usługi Office 365 w usłudze Defender, może pomóc Chronić Twoją organizację przed atakami wyłudzania informacji opartymi na złośliwej personifikacji i innymi atakami wyłudzania informacji. Jeśli nie skonfigurowano domeny niestandardowej, nie trzeba tego robić.| |![zielony znacznik wyboru.](../media/green-check-mark.png)|
...
Na poniższym diagramie przedstawiono te możliwości.
:::image type="content" source="../media/m365-security-bdm-illustrations-known-threats.png" alt-text="Zalecane funkcje ochrony przed znanymi zagrożeniami" lightbox="../media/m365-security-bdm-illustrations-known-threats.png":::


## <a name="protect-against-unknown-threats"></a>Ochrona przed nieznanymi zagrożeniami

Po dodaniu dodatkowych zabezpieczeń do kont uprzywilejowanych i ochronie przed znanymi atakami możesz skupić się na ochronie przed nieznanymi zagrożeniami. Bardziej zdeterminowani i zaawansowani adwersiści korzystają z innowacyjnych i nowych, nieznanych metod ataków w organizacjach. Dzięki rozległej telemetrii danych firmy Microsoft zebranych ponad miliardy urządzeń, aplikacji i usług firma Ochrona usługi Office 365 w usłudze Defender może przeprowadzać na platformach Windows, Office 365 i Azure, aby zapobiegać atakom programu Zero-Day, korzystania ze środowisk skrzynki piasku oraz sprawdzać poprawność przed zezwoleniem na dostęp do zawartości.

|Zalecenie  |E3  |E5  |
|---------|---------|---------|
|**Skonfiguruj Ochrona usługi Office 365 w usłudze Microsoft Defender**:<br>*Sejf załączników<br>* Sejf linków    <br>*Ochrona punktu końcowego w usłudze Microsoft Defender do SharePoint, OneDrive i Microsoft Teams<br>* ochrony przed wyłudzaniem informacji w Ochrona usługi Office 365 w usłudze Defender zabezpieczeń|         |![zielony znacznik wyboru.](../media/green-check-mark.png) |
|**Konfigurowanie Ochrona punktu końcowego w usłudze Microsoft Defender funkcji**:<br>*<br>Program antywirusowy Windows Defender* exploit protection <br> *Zmniejszenie powierzchni ataków <br>*    Izolacji na podstawie sprzętu <br>* Kontrolowany dostęp do folderu     |         |![zielony znacznik wyboru.](../media/green-check-mark.png) |
|**Odkrywaj Microsoft Defender for Cloud Apps** SaaS i zacznij korzystać z analizy zachowania oraz wykrywania anomalii. |         |![zielony znacznik wyboru.](../media/green-check-mark.png) |
...
|**Implementowanie zasad klasyfikacji danych i ochrony informacji**. Implementuj etykiety wrażliwości i używaj ich do klasyfikowania i stosowania ochrony do danych poufnych. Tych etykiet można również używać w zasadach ochrony przed utratą danych. Jeśli używasz etykiet usługi Azure Information Protection, zalecamy unikanie tworzenia nowych etykiet w innych centrach aadministracyjnym.|         |![zielony znacznik wyboru.](../media/green-check-mark.png)|
|**Ochrona danych w aplikacjach i usługach innych firm przy Defender dla Chmury aplikacje**. Skonfiguruj Defender dla Chmury Apps w celu ochrony poufnych informacji w aplikacjach w chmurze innych firm, takich jak Salesforce, Box lub Dropbox. Możesz używać typów informacji poufnych oraz etykiet wrażliwości utworzonych w aplikacji Defender dla Chmury Apps i stosować je we wszystkich aplikacjach SaaS. <br><br>Microsoft Defender for Cloud Apps umożliwia wymuszanie wielu zautomatyzowanych procesów. Zasady można skonfigurować tak, aby zapewniać ciągłe skanowanie zgodności, zadania zbierania elektronicznych materiałów dowodowych z przepisami, zasady DLP dotyczące poufnej zawartości udostępnianej publicznie i nie tylko. Defender dla Chmury aplikacje mogą monitorować dowolny typ pliku na podstawie ponad 20 filtrów metadanych (na przykład na poziomie dostępu, typ pliku). |         |![zielony znacznik wyboru.](../media/green-check-mark.png)|
...
|Użyj **Ochrona usługi Office 365 w usłudze Microsoft Defender** narzędzi:<br>*Możliwości analizy zagrożeń i reakcji<br>*    Zautomatyzowane badanie i odpowiedź |         |![zielony znacznik wyboru.](../media/green-check-mark.png)|
...
|Używaj **Microsoft Defender for Cloud Apps** do wykrywania nietypowych zachowań w aplikacjach w chmurze w celu identyfikowania oprogramowania wymuszającego okup, naruszonych użytkowników lub aplikacji rogu, automatycznego analizowania użycia wysokiego ryzyka i automatycznego podejmowania działań naprawczych w celu ograniczenia ryzyka dla Twojej organizacji.|         |:::image type="content" source="../media/green-check-mark.png" alt-text="Przykład zielonego, kolorowego znacznika wyboru" lightbox="../media/green-check-mark.png":::|
...
|**[Wdrażaj Microsoft Defender for Identity](/azure-advanced-threat-protection/what-is-atp)**, aby monitorować i chronić się przed zagrożeniami w Twoim lokalna usługa Active Directory sieci.   |         |![zielony znacznik wyboru.](../media/green-check-mark.png) |
|Za **Microsoft Defender dla Chmury** możesz monitorować zagrożenia w obciążeniach hybrydowymi i chmurowych. Microsoft Defender dla Chmury bezpłatną warstwę możliwości i standardową warstwę możliwości opłacaną w oparciu o godziny zasobów lub transakcje.|         |         |

Na poniższym diagramie przedstawiono te możliwości.

:::image type="content" source="../media/m365-security-bdm-illustrations-monitoring-auditing.png" alt-text="Zalecane funkcje ciągłego monitorowania i inspekcji" lightbox="../media/m365-security-bdm-illustrations-monitoring-auditing.png":::


Zalecane najważniejsze działania monitorujące:

- **Tygodniowy przegląd wyników** bezpiecznego firmy Microsoft — wynik bezpiecznego to centralna lokalizacja do uzyskiwania dostępu do stanu zabezpieczeń dzierżawy i do podjęcia działań na podstawie najlepszych zaleceń. Takie sprawdzanie zaleca się przeprowadzać co tydzień. Bezpieczny wynik zawiera zalecenia dotyczące usług Azure AD, Intune, Defender dla Chmury Apps i Ochrona punktu końcowego w usłudze Microsoft Defender, a także Office 365.
...
- **Tygodniowe** przeglądanie najgorętszego złośliwego oprogramowania i wyłudowanych użytkowników — w Eksploratorze zagrożeń w programie Ochrona usługi Office 365 w usłudze Microsoft Defender można przeglądać użytkowników, którzy są kierowani złośliwym oprogramowaniem i wyłudzeniem informacji, oraz dowiedzieć się, jaka jest główna przyczyna tego wpływu na tych użytkowników.
