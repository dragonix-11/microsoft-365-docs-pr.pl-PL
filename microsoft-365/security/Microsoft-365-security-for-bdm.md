...
|Zaimplementuj Azure Active Directory (Azure AD) Privileged Identity Management (PIM), aby zastosować uprzywilejowany dostęp just in time do zasobów usługi Azure AD i platformy Azure. Możesz również dowiedzieć się, kto ma dostęp, i przejrzeć dostęp uprzywilejowany.|         | ![zielony znacznik wyboru.](../media/green-check-mark.png)|
...
|**Blokuj połączenia z krajów, z których nie robisz interesów**. Utwórz zasady dostępu warunkowego usługi Azure AD, aby zablokować wszelkie połączenia pochodzące z tych krajów, skutecznie tworząc zaporę geograficzną wokół dzierżawy.| |![zielony znacznik wyboru.](../media/green-check-mark.png)|
...
|Zalecenie  |E3  |E5  |
|---------|---------|---------|
|**Skonfiguruj Ochrona usługi Office 365 w usłudze Microsoft Defender**:<br>*Sejf załączników<br>* Sejf łącza    <br>*Ochrona punktu końcowego w usłudze Microsoft Defender dla SharePoint, OneDrive i Microsoft Teams<br>* anti-phishing ochrona Ochrona usługi Office 365 w usłudze Defender|         |![zielony znacznik wyboru.](../media/green-check-mark.png) |
|**Konfigurowanie możliwości Ochrona punktu końcowego w usłudze Microsoft Defender**:<br>*<br>Program antywirusowy Windows Defender* exploit protection <br> *Zmniejszanie obszaru podatnego <br>na ataki*    Izolacja sprzętowa <br>* Kontrolowany dostęp do folderu     |         |![zielony znacznik wyboru.](../media/green-check-mark.png) |
...
|Użyj **narzędzi Ochrona usługi Office 365 w usłudze Microsoft Defender**:<br>*Możliwości badania zagrożeń i reagowania na nie<br>*    Zautomatyzowane badanie i reagowanie |         |![zielony znacznik wyboru.](../media/green-check-mark.png)|
|Użyj **usługi Microsoft Defender dla punktu końcowego**:<br> *[Wykrywanie i reagowanie](/windows/security/threat-protection/microsoft-defender-atp/overview-endpoint-detection-response) <br>na punkty końcowe*    Zautomatyzowane badanie i korygowanie Wskaźnik bezpieczeństwa <br>*    [Zaawansowane wyszukiwanie zagrożeń](/windows/security/threat-protection/microsoft-defender-atp/advanced-hunting-overview) <br>|         |![zielony znacznik wyboru.](../media/green-check-mark.png)|
...
- **Przegląd wskaźnika bezpieczeństwa firmy Microsoft co tydzień** — wskaźnik bezpieczeństwa to centralna lokalizacja umożliwiająca dostęp do stanu zabezpieczeń dzierżawy i podjęcie akcji na podstawie najważniejszych zaleceń. Zaleca się wykonanie tego sprawdzania co tydzień. Wskaźnik bezpieczeństwa obejmuje zalecenia z różnych usług Azure AD, Intune, Defender dla Chmury Apps i Ochrona punktu końcowego w usłudze Microsoft Defender, a także Office 365.
- **Co tydzień przejrzyj ryzykowne logowania** — co tydzień przejrzyj ryzykowne logowania za pomocą centrum administracyjnego usługi Azure AD. Zalecany zestaw reguł tożsamości i dostępu do urządzeń zawiera zasady wymuszania zmiany hasła podczas ryzykownych logowań.  
