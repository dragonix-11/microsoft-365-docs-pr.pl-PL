...
### <a name="hkey_current_user-settings"></a>HKEY_CURRENT_USER ustawień
...
|---|---|---|---|---|
|ActiveX|Pakiet Office|ActiveX inicjowania sterowania|**6**|**Tak** dla następujących wartości: <ul><li>**3**</li><li>**4**</li><li>**5**</li><li>**6**</li></ul>|
...
|Dodatki z & rozszerzalność|Excel <p> PowerPoint <p> Project <p> Publisher <p> Visio <p> Word|Wyłączanie powiadomień na pasku zaufania dla niepodpisanych dodatków aplikacji i blokowanie ich|**Włączone**|**Tak** dla wartości **Wyłączone**.|
|Dodatki z & rozszerzalność|Excel <p> PowerPoint <p> Project <p> Publisher <p> Visio <p> Word|Wymaganie, aby dodatki aplikacji zostały podpisane przez zaufane Publisher|**Włączone**|Nie|
|Dodatki z & rozszerzalność|Excel|Nie pokazuj alertu ostrzegawczego Automatyczne automatyczne opublikowanie ponowne|**Wyłączone**|Nie|
|Dodatki z & rozszerzalność|Excel|Powiadomienie dotyczące funkcji WEBSERVICE Ustawienia|**Wyłącz wszystko, korzystając z powiadomienia**|**Tak** dla następujących wartości: <ul><li>**Wyłącz wszystko, korzystając z powiadomienia**</li><li>**Wyłączone**</li><li>**Nieskonfigurowane**</li></ul>|
|Dodatki z & rozszerzalność|Pakiet Office|Wyłączanie Office z ankiet w SharePoint Server dla opublikowanych linków|**Wyłączone**|Nie|
|Dodatki z & rozszerzalność|Pakiet Office|Wyłączanie rozszerzania interfejsu użytkownika na dokumenty i szablony|Disallow in Word = True <p> Nie zezwalaj na Project = Fałsz <p> Nie zezwalaj na Excel = Prawda <p> Nie zezwalaj na Visio= Fałsz <p> Nie zezwalaj na PowerPoint = Prawda <p> Nie zezwalaj w programie Access = True <p> Nie zezwalaj na Outlook = Prawda <p> Nie zezwalaj na Publisher = Prawda <p> Disallow in InfoPath = True|Nie|
|Dodatki z & rozszerzalność|Outlook|Konfigurowanie monitu Outlook modelu obiektów podczas uzyskiwania dostępu do książki adresowej|**Automatycznie odmów**|**Tak** dla następujących wartości: <ul><li>**Monituj użytkownika**</li><li>**Monituj użytkownika na podstawie zabezpieczeń komputera**</li><li>**Wyłączone**</li><li>**Nieskonfigurowane**</li></ul>|
|Dodatki z & rozszerzalność|Outlook|Konfigurowanie Outlook modelu obiektów Podczas uzyskiwania dostępu do właściwości Formuła obiektu UserProperty|**Automatycznie odmów**|**Tak** dla następujących wartości: <ul><li>**Monituj użytkownika**</li><li>**Monituj użytkownika na podstawie zabezpieczeń komputera**</li><li>**Wyłączone**</li><li>**Nieskonfigurowane**</li></ul>|
|Dodatki z & rozszerzalność|Outlook|Konfigurowanie monitu Outlook modelu obiektów podczas wykonywania polecenia Zapisz jako|**Automatycznie odmów**|**Tak** dla następujących wartości: <ul><li>**Monituj użytkownika**</li><li>**Monituj użytkownika na podstawie zabezpieczeń komputera**</li><li>**Wyłączone**</li><li>**Nieskonfigurowane**</li></ul>|
...
|Dodatki z & rozszerzalność|Outlook|Konfigurowanie monitu Outlook modelu obiektów podczas wysyłania poczty|**Automatycznie odmów**|**Tak** dla następujących wartości: <ul><li>**Monituj użytkownika**</li><li>**Monituj użytkownika na podstawie zabezpieczeń komputera**</li><li>**Wyłączone**</li><li>**Nieskonfigurowane**</li></ul>|
|Dodatki z & rozszerzalność|Outlook|Ustawianie Outlook wykonywania akcji niestandardowych modelu obiektów|**Automatycznie odmów**|**Tak** dla następujących wartości: <ul><li>**Monituj użytkownika**</li><li>**Monituj użytkownika na podstawie zabezpieczeń komputera**</li><li>**Wyłączone**</li><li>**Nieskonfigurowane**</li></ul>|
|Dodatki z & rozszerzalność|PowerPoint|Uruchamianie programów|**wyłącz (nie uruchamiaj żadnych programów)**|**Tak** dla wartości **Włącz (monituj użytkownik przed uruchomieniem)**|
|Dodatki z & rozszerzalność|Word <p> Excel|Wyłączanie używania manifestów w dokumencie inteligentnym|**Włączone**|Nie|
...
|Makra|Access <p> Excel <p> PowerPoint <p> Visio <p> Word|Blokowanie uruchamiania makr w Office z Internetu|**Włączone**|**Tak** dla następujących wartości: <ul><li>**Wyłączone**</li><li>**Nieskonfigurowane**</li></ul>|
...
|Makra|Outlook|Outlook tryb zabezpieczeń|**Korzystanie Outlook zabezpieczeń zasady grupy**|Wymagane do włączenia wszystkich Outlook zasad grupy. <p> Wspomniano jako zależność (te zasady nie blokują samej zawartości aktywnej).|
...
|Dodatki z & rozszerzalność|Pakiet Office|Zarządzanie zasobami dodatków|excel.exe = Prawda <p> exprwd.exe = Prawda <p> groove.exe = Prawda <p> msaccess.exe = Prawda <p> mse7.exe = Prawda <p> mspub.exe = Prawda <p> onent.exe = Prawda <p> outlook.exe = Prawda <p> powerpnt.exe = Prawda <p> pptview.exe = Prawda <p> spDesign.exe = Prawda <p> visio.exe = Prawda <p> winproj.exe = Prawda <p> winword.exe = Prawda|Nie|
|Dodatki z & rozszerzalność|Pakiet Office|Blokowanie aktywacji w programie Flash Office dokumentach|Zobacz plik ADMX/ADML przewodnika po zabezpieczeniach firmy Microsoft, aby uzyskać listę plików COM killbits w celu zablokowania wszystkich aktywacji programu Flash w Microsoft 365 aplikacji. Pliki ADMX/ADML dla planu bazowego zabezpieczeń przedsiębiorstwa są dostępne w zestawie [narzędzi do zgodności zabezpieczeń](https://www.microsoft.com/download/details.aspx?id=55319).|Nie|
|Jscript & VBScript|Pakiet Office|Ograniczanie wykonywania starszych JScript dla Office|**Włączone**: <p> Access: 69632 <p> Excel: 69632 <p> OneNote: 69632 <p> Outlook: 69632 <p> PowerPoint: 69632 <p> Project: 69632 <p> Publisher: 69632 <p> Visio: 69632 <p> Word: 69632|Nie|
