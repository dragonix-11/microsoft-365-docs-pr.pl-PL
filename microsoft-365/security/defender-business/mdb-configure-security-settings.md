...
Po dojecheniu urządzeń firmy do usługi Microsoft Defender dla Firm następnym krokiem jest wyświetlenie i w razie potrzeby edytowanie zasad zabezpieczeń oraz ustawień. Zasady zabezpieczeń to między innymi:

- **[Zasady ochrony następnej generacji](#view-or-edit-your-next-generation-protection-policies)**, które określają ochronę antywirusową i ochrony przed złośliwym oprogramowaniem dla urządzeń firmowych
...
Nie wszystkie witryny internetowe w tych kategoriach są złośliwe, ale mogą być problematyczne dla Twojej firmy z powodu przepisów dotyczących zgodności z przepisami, wykorzystania przepustowości lub innych kwestii. Ponadto można tworzyć zasady tylko do inspekcji, aby lepiej zrozumieć, czy zespół zabezpieczeń ma blokować kategorie witryn internetowych.
