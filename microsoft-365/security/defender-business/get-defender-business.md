...
1. Przejdź do [Microsoft Defender dla Firm](https://www.microsoft.com/security/business/threat-protection/microsoft-defender-business) strony internetowej i wybierz opcję wypróbowania lub zakupu usługi Defender dla Firm.
...
4. Użyj jednej z następujących procedur:<br/>
...
Gdy wszystko będzie gotowe do rozpoczęcia pracy, będziesz pracować z dwoma głównymi portalami: Centrum administracyjne platformy Microsoft 365 i portalem Microsoft 365 Defender.
...
- [Zobacz podręcznik wersji próbnej: Microsoft Defender dla Firm](trial-playbook-defender-business.md).
- [Użyj kreatora konfiguracji w Microsoft Defender dla Firm](mdb-use-wizard.md).
- [Zobacz proces konfiguracji i konfiguracji usługi Defender dla firm](mdb-setup-configuration.md).
- [Zobacz, jak uzyskać pomoc i pomoc techniczną dla usługi Defender dla Firm](mdb-get-help.md) (na wypadek, gdy potrzebujesz pomocy).