...
| `RegistryValueType` | `string` | Typ danych, taki jak dane binarne lub ciąg, wartości rejestru, do których zastosowano zarejestrowane działanie |
...
| `PreviousRegistryKey` | `string` | Oryginalny klucz rejestru wartości rejestru przed jej zmodyfikowaną |
| `PreviousRegistryValueName` | `string` | Oryginalna nazwa wartości rejestru przed jej zmodyfikowaniem |
| `PreviousRegistryValueData` | `string` | Oryginalne dane wartości rejestru przed jej zmodyfikowaniem |
