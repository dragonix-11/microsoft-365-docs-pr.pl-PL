---
title: Co nowego w rozwiązaniach dotyczących ryzyka i zgodności w usłudze Microsoft Purview
f1.keywords:
- NOCSH
...
description: Niezależnie od tego, czy chodzi o dodawanie nowych rozwiązań do centrum zgodności, aktualizowanie istniejących funkcji na podstawie opinii, czy wprowadzanie nowej i zaktualizowanej dokumentacji, platforma Microsoft 365 pomaga być na bieżąco z ciągle zmieniającym się poziomem zgodności. Dowiedz się, co mieliśmy do tego miesiąca.
...
ms.locfileid: "66637788"
---
# <a name="whats-new-in-microsoft-purview-risk-and-compliance-solutions"></a>Co nowego w rozwiązaniach dotyczących ryzyka i zgodności w usłudze Microsoft Purview

Niezależnie od tego, czy chodzi o dodawanie nowych rozwiązań do [portal zgodności Microsoft Purview](microsoft-365-compliance-center.md), aktualizowanie istniejących funkcji na podstawie opinii, czy wprowadzanie nowej i zaktualizowanej dokumentacji, platforma Microsoft 365 pomaga być na bieżąco z ciągle zmieniającym się poziomem zgodności. Spójrz poniżej, aby zobaczyć, co nowego w usłudze Microsoft Purview już dziś.
...
> - [Co nowego w centrum administracyjnym programu SharePoint](/sharepoint/what-s-new-in-admin-center)
> - [Co nowego w usłudze Microsoft 365 Defender](../security/defender/whats-new.md)
>
> Odwiedź stronę [Plan platformy Microsoft 365](https://www.microsoft.com/microsoft-365/roadmap) , aby dowiedzieć się więcej o funkcjach platformy Microsoft 365, które zostały uruchomione, wdrażane, są w programie, zostały anulowane lub wcześniej wydane.

## <a name="may-2022"></a>Maj 2022

### <a name="communication-compliance"></a>Zgodność w komunikacji

- [Raporty i inspekcje zgodności komunikacji](communication-compliance-reports-audits.md) — zaktualizowano limity rozmiaru plików dla wyeksportowanych raportów.
- [Zasady zgodności komunikacji](communication-compliance-policies.md) — wyjaśnione komunikaty zgłaszane przez użytkowników wyłączają/włączają proces i wyjaśniają przetwarzanie dla usługi Teams i programu Exchange.

### <a name="compliance-manager"></a>Menedżer zgodności

- [Alerty i zasady alertów](compliance-manager-alert-policies.md) — nowa sekcja wyjaśniająca domyślne zasady zmiany oceny dla wszystkich organizacji.
- [Praca z akcjami poprawy](compliance-manager-improvement-actions.md) — wyjaśnione stany stanu dla stanu implementacji i stanu testu, rozróżnianie tych ostatnich między automatycznie testowanymi akcjami a ręcznie przetestowanymi akcjami.
- [Lista szablonów](compliance-manager-templates-list.md) — dodano dwa nowe szablony w regionie Europa, Bliski Wschód i Afryka (EMEA): Qatar National Information Assurance (NIA) i UAE Data Privacy Law.

### <a name="compliance-offerings--service-assurance"></a>Oferty zgodności & service assurance

- [Cykl życia opracowywania zabezpieczeń firmy Microsoft](/compliance/assurance/assurance-microsoft-security-development-lifecycle) — nowy temat zapewniania SDL dla usług firmy Microsoft.

### <a name="data-lifecycle-management-and-records-management"></a>Zarządzanie cyklem życia danych i zarządzanie rekordami

- Obecnie wprowadzana w wersji zapoznawczej: nowa [opcja ponownego etykietowania na końcu okresu przechowywania](retention-settings.md#relabeling-at-the-end-of-the-retention-period).
- Nowe wskazówki dotyczące wdrażania: [Wdrażanie rozwiązania do zarządzania danymi za pomocą usługi Microsoft Purview](data-governance-solution.md)
- Poprawka w dokumentacji w celu potwierdzenia, że skrzynki pocztowe zasobów są obsługiwane w przypadku przechowywania i usuwania programu Exchange zarówno dla zakresów statycznych, jak i zakresów adaptacyjnych. W przypadku zakresów statycznych skrzynki pocztowe zasobów są domyślnie uwzględniane w zasadach całej organizacji (domyślnie Wszystkie).
- Nowa dokumentacja dla użytkowników końcowych: [Zarządzanie magazynem poczty e-mail przy użyciu skrzynek pocztowych archiwum online](https://support.services.microsoft.com/office/manage-email-storage-with-online-archive-mailboxes-1cae7d17-7813-4fe8-8ca2-9a5494e9a721)

### <a name="data-loss-prevention"></a>Zapobieganie utracie danych

- [Wysyłanie powiadomień e-mail i wskazówek dotyczących zasad DLP](use-notifications-and-policy-tips.md) — dodano nowe informacje o tym, co wyzwala powiadomienie i kto może je otrzymać.

### <a name="information-barriers"></a>Bariery informacyjne

- [Dowiedz się więcej o barierach informacyjnych](information-barriers.md), [rozpoczynaniu pracy z barierami informacyjnymi](information-barriers-policies.md) — refaktoryzowanej strukturze tematów i dodano wyjaśnienie dotyczące Exchange Online wsparcia i ograniczeń, zaktualizowane w celu uwzględnienia obsługi nowego środowiska interfejsu użytkownika IB.

### <a name="insider-risk-management"></a>Zarządzanie ryzykiem wewnętrznym

- [Wprowadzenie do ustawień zarządzania ryzykiem wewnętrznym](insider-risk-management-settings.md) — dodano wskazówki dotyczące nowych wskaźników aplikacji defender for Cloud, nowej anomalii jako zdarzenia wyzwalającego w progach niestandardowych, obsługi zasad priorytetyzacji nowego rozszerzenia pliku i etykiet poufności.
- [Przypadki zarządzania ryzykiem wewnętrznym](insider-risk-management-cases.md) — wyjaśniono eskalację do wskazówek dotyczących przypadków zbierania elektronicznych materiałów dowodowych.

### <a name="microsoft-priva"></a>Microsoft Priva

- [Dowiedz się więcej o bezpłatnej wersji próbnej Priva](/privacy/priva/priva-trial) — zaktualizowany link do nowych uniwersalnych warunków i postanowień wersji próbnej platformy Microsoft 365 oraz drobnych aktualizacji w celu wyjaśnienia ról i uprawnień.
- [Wprowadzenie do funkcji Priva](/privacy/priva/priva-setup) — dodano sekcję wskazującą ograniczenia dotyczące dostępności priva.

### <a name="sensitive-information-types"></a>Typy informacji poufnych

- [Dowiedz się więcej o dokładnych typach informacji poufnych opartych na dopasowaniu danych](sit-learn-about-exact-data-match-based-sits.md) — od eskalacji przez klienta dodano regiony, w których jest obsługiwany program EDM, oraz procedury znajdowania regionu dzierżawy.
- [Utwórz pakiet reguł EDM SIT](sit-get-started-exact-data-match-create-rule-package.md) — dodano polecenie "praca z określonymi typami danych" z artykułu schematu.
- [Utwórz schemat dla EDM SIT — usunięto](sit-get-started-exact-data-match-create-schema.md) polecenie "praca z określonymi typami danych".
- [Użyj nazwanych jednostek w zasadach DLP](named-entities-use.md) — dodano instrukcję obsługi dla Microsoft Defender for Cloud Apps.

### <a name="sensitivity-labels"></a>Etykiety wrażliwości

- Nowa opcja na końcu procesu tworzenia lub edytowania etykiet, aby automatycznie [konwertować ustawienia automatycznego etykietowania na zasady automatycznego etykietowania](apply-sensitivity-label-automatically.md#convert-your-label-settings-into-an-auto-labeling-policy).
- Zasady automatycznego etykietowania dla programów SharePoint i OneDrive mogą teraz stosować etykiety z szyfrowaniem, gdy konto, które ostatnio zmodyfikowało plik, nie istnieje już w Azure AD.
- Etykiety kontenerów są obsługiwane w przypadku sieci dostarczania zawartości Office 365 (CDN).
- Wyjaśnienia dotyczące [usuwania i usuwania etykiet](create-sensitivity-labels.md#removing-and-deleting-labels).
- Nowe [typowe scenariusze](get-started-with-sensitivity-labels.md#common-scenarios-for-sensitivity-labels):
  - Etykietowanie kolumn bazy danych SQL przy użyciu tych samych etykiet poufności, które są używane w przypadku plików i wiadomości e-mail, dzięki czemu organizacja ma ujednolicone rozwiązanie do etykietowania, które nadal chroni dane strukturalne podczas eksportowania
...
- [Tworzenie zasad zgodności komunikacji i zarządzanie nimi](communication-compliance-policies.md) — zaktualizowane o wskazówki dotyczące nowej funkcji zasad komunikatów zgłaszanych przez użytkowników na potrzeby integracji z usługą Microsoft Teams.
- [Wprowadzenie do zgodności z komunikacją](communication-compliance-configure.md) — zaktualizowano w celu dodania wyjaśnień dotyczących subskrypcji i licencjonowania F5.
...
- Obecnie wdrażana: nowa opcja etykiety w wersji zapoznawczej: "Domyślnie odblokuj ten rekord". Aby uzyskać więcej informacji, zobacz [Konfigurowanie etykiet przechowywania do deklarowania rekordów](declare-records.md#configuring-retention-labels-to-declare-records) i [Używanie przechowywania wersji rekordów do aktualizowania rekordów przechowywanych w programie SharePoint lub OneDrive](record-versioning.md).

### <a name="data-loss-prevention"></a>Zapobieganie utracie danych

- Zaktualizowano artykuły dotyczące dołączania urządzeń z systemem macOS:
...
- Zaktualizowano artykuły dotyczące dołączania urządzeń z systemem macOS:
  - [Dołączanie urządzeń z systemem macOS do platformy Microsoft 365 — omówienie](device-onboarding-macos-overview.md)
  ...
  - [Dołączanie i dołączanie urządzeń z systemem macOS do rozwiązań usługi Microsoft Purview przy użyciu Intune](device-onboarding-offboarding-macos-intune.md)
  ...
  - [Dołączanie i dołączanie urządzeń z systemem macOS do rozwiązań usługi Microsoft Purview przy użyciu narzędzia JAMF Pro](device-onboarding-offboarding-macos-jamfpro.md)

### <a name="information-barriers"></a>Bariery informacyjne

- [Korzystanie z barier informacyjnych w programie SharePoint](/sharepoint/information-barriers) — dodano wskazówki dotyczące obsługi nowego kanału prywatnego w programie SharePoint.
...
- Nowo obsługiwany scenariusz dla witryn programu SharePoint, teraz w wersji zapoznawczej: [Konfigurowanie uprawnień do udostępniania witryn przy użyciu ustawień zaawansowanych programu PowerShell](sensitivity-labels-teams-groups-sites.md#configure-site-sharing-permissions-by-using-powershell-advanced-settings)
...
- Usunięte konta usługi OneDrive są teraz poprawnie wyświetlane w wynikach symulacji dla zasad automatycznego etykietowania.
...
Aby sprostać wyzwaniom związanym z dzisiejszym zdecentralizowanym, bogatym w dane miejscem pracy, wprowadzamy [usługę Microsoft Purview](https://aka.ms/microsoftpurview), kompleksowy zestaw rozwiązań, które ułatwiają zrozumienie, zarządzanie i ochronę całej bazy danych. Ta nowa rodzina marek łączy możliwości dawnego Mapa danych w Microsoft Purview i portfolio zgodności platformy Microsoft 365, na których klienci już polegają, zapewniając ujednolicone zarządzanie danymi i zarządzanie ryzykiem dla Twojej organizacji.

| **Poprzednie imię i nazwisko** | **Nowa nazwa** | **Opis** |
|:----------------|:-------------|:----------------|
| Zaawansowany audyt platformy Microsoft 365 <br><br> Microsoft 365 Basic Audit | Inspekcja w Microsoft Purview (Premium) <br><br> Inspekcja w Microsoft Purview (standardowa)| Rozwiązania do inspekcji zapewniają zintegrowane rozwiązanie ułatwiające organizacjom skuteczne reagowanie na zdarzenia związane z bezpieczeństwem, badania kryminalistyczne, dochodzenia wewnętrzne i obowiązki w zakresie zgodności. Aby dowiedzieć się więcej, zobacz [Microsoft Purview Advanced Audit (Premium)](advanced-audit.md) i [Microsoft Purview Advanced Audit (Standard)](set-up-basic-audit.md). |
| Zgodność z komunikacją na platformie Microsoft 365 | Zgodność w komunikacji w usłudze Microsoft Purview | Zgodność z komunikacją pomaga zminimalizować ryzyko, pomagając szybko wykrywać, przechwytywać i podejmować akcje korygowania dla kanałów komunikacyjnych firmy i naruszeń zasad. Aby dowiedzieć się więcej, zobacz [Zgodność w komunikacji w Microsoft Purview](communication-compliance-solution-overview.md). |
| Microsoft Compliance Manager | Menedżer zgodności w Microsoft Purview | Menedżer zgodności może pomóc w całym procesie zapewniania zgodności, od tworzenia spisu zagrożeń związanych z ochroną danych po zarządzanie złożonością wdrażania mechanizmów kontroli, zachowanie aktualności z przepisami i certyfikatami oraz raportowanie do audytorów. Aby dowiedzieć się więcej, zobacz [Microsoft Purview Compliance Manager](compliance-manager.md). |
| Klucz klienta platformy Microsoft 365 | Klucz klienta Microsoft Purview | Klucz klienta zapewnia dodatkową ochronę przed wyświetlaniem danych przez nieautoryzowane systemy lub personel oraz uzupełnia szyfrowanie dysków BitLocker w centrach danych firmy Microsoft. Aby dowiedzieć się więcej, zobacz [Klucz klienta usługi Microsoft Purview](customer-key-overview.md). |
| Office 365 skrytka klienta | Skrytka klienta w Microsoft Purview | Skrytka klienta zapewnia, że firma Microsoft nie może uzyskać dostępu do Zawartości w celu wykonywania operacji usług bez twojej jawnej zgody. Skrytka klienta umożliwia przejście do procesu przepływu pracy zatwierdzania używanego przez firmę Microsoft w celu zapewnienia, że tylko autoryzowane żądania zezwalają na dostęp do zawartości. Aby dowiedzieć się więcej, zobacz [Microsoft Purview Customer Lockbox (Skrytka klienta usługi Microsoft Purview](customer-lockbox-requests.md)). |
...
| Podwójne szyfrowanie kluczy dla platformy Microsoft 365 | Szyfrowanie podwójnym kluczem w Microsoft Purview | Szyfrowanie podwójnym kluczem (DKE) używa dwóch kluczy razem w celu uzyskania dostępu do chronionej zawartości. Firma Microsoft przechowuje jeden klucz na platformie Microsoft Azure, a Ty jesteś w posiadaniu drugiego klucza. Aby dowiedzieć się więcej, zobacz [Szyfrowanie podwójnego klucza w usłudze Microsoft Purview](double-key-encryption.md) |
| Bariery informacyjne platformy Microsoft 365 | Bariery informacyjne w usłudze Microsoft Purview | Bariery informacyjne to rozwiązanie, które ogranicza komunikację i współpracę między niektórymi osobami w organizacji w celu ochrony informacji wewnętrznych. Aby dowiedzieć się więcej, zobacz [Bariery informacyjne usługi Microsoft Purview](information-barriers-solution-overview.md). |
...
- [Praca z akcjami poprawy](compliance-manager-improvement-actions.md), [Wprowadzenie do menedżera zgodności](compliance-manager-setup.md) — dodano informacje o kolejnych akcjach poprawy, które można automatycznie monitorować i testować ("ciągła ocena zgodności"); Obejmuje to nowe możliwości nadrzędnego stanu testowania akcji względem stanu innej akcji.

### <a name="data-classification"></a>Klasyfikacja danych

- [Wprowadzenie do Eksploratora zawartości](data-classification-content-explorer.md) — dodano wskazówki dotyczące usługi Teams, sekcja licencjonowania wskazywała opisy usług.

### <a name="data-lifecycle-management-and-records-management"></a>Zarządzanie cyklem życia danych i zarządzanie rekordami

- [Zasady przechowywania usługi Yammer](create-retention-policies.md#retention-policy-for-yammer-locations) są teraz ogólnie dostępne.
- Obsługa kanałów udostępnionych, obecnie w wersji zapoznawczej. Podczas konfigurowania zasad przechowywania dla lokalizacji komunikatów kanału usługi Teams wszystkie kanały udostępnione dziedziczą ustawienia przechowywania po swoim zespole nadrzędnym.
- [Limity dla dzierżawy dotyczące rozporządzania zawartością](retention-limits.md#maximum-number-of-items-for-disposition).

### <a name="data-loss-prevention"></a>Zapobieganie utracie danych

- [Zapobieganie utracie danych i usługa Microsoft Teams](dlp-microsoft-teams.md) — publiczna wersja zapoznawcza zawartości Kanały usługi Share Teams.
- [Wprowadzenie do rozszerzenia zgodności firmy Microsoft](dlp-chrome-get-started.md) — publiczna wersja zapoznawcza ograniczonych grup aplikacji, usuwanie instrukcji dotyczących klucza rejestru, konfiguracja jest teraz domyślnie włączona.
...
- [Wprowadzenie do ochrony przed utratą danych w usłudze Power BI](dlp-powerbi-get-started.md) — nowość dla publicznej wersji zapoznawczej.
- 
...
- [Wprowadzenie do zarządzania ryzykiem wewnętrznym](insider-risk-management-configure.md) — dodano nowe zadania do wskazówek dotyczących zalecanych akcji.
- [Wprowadzenie do ustawień zarządzania ryzykiem wewnętrznym](insider-risk-management-settings.md) — nowe aktualizacje funkcji powiadomień i alertów e-mail, nowe aktualizacje powiadomień analitycznych.
...
- [Utwórz żądanie praw podmiotu](/privacy/priva/subject-rights-requests-create) — dodano szczegóły dotyczące uściślania wyszukiwań oraz wybierania warunków i atrybutów; dodano informacje o nowych funkcjach, które umożliwiają użytkownikom wybieranie wszystkich wersji elementów programu SharePoint w wyszukiwaniu (w porównaniu z ustawieniem domyślnym, które zwraca tylko bieżącą wersję elementów programu SharePoint).
...
- [Etykiety poufności dla usługi Teams](sensitivity-labels-teams-groups-sites.md):
  ...
  - Obsługa szablonów wymienionych wcześniej jako [nieobsługiwane w przypadku interfejsów API programu Teams Graph i poleceń cmdlet programu PowerShell]( /microsoftteams/sensitivity-labels#limitations).  
- W przypadku inspekcji programów Word, Excel i PowerPoint w sieci Web tekst uzasadnienia jest teraz w pełni wdrażany.
- Stosowanie etykiety domyślnej do istniejących dokumentów dla programów Word, Excel i PowerPoint w sieci Web jest teraz w pełni wdrażane.

## <a name="february-2022"></a>Luty 2022 r.

### <a name="ediscovery"></a>Zbierania elektronicznych materiałów dowodowych

- [Zarządzanie szablonami komunikacji opiekuna w usłudze eDiscovery (Premium)](advanced-ediscovery-communications-library.md) — menedżerowie zbierania elektronicznych materiałów dowodowych mogą teraz tworzyć szablony komunikacji opiekuna, które mogą być używane w dowolnym przypadku zbierania elektronicznych materiałów dowodowych (Premium) w organizacji.
- [Zarządzanie urzędnikami wystawiającym certyfikaty w usłudze eDiscovery (Premium)](advanced-ediscovery-issuing-officers.md) — menedżerowie zbierania elektronicznych materiałów dowodowych mogą dodać listę urzędników wystawiających certyfikaty, którzy mogą być przypisani do komunikacji z opiekunem w dowolnym przypadku zbierania elektronicznych materiałów dowodowych (Premium) w organizacji.

### <a name="data-lifecycle-management-and-records-management"></a>Zarządzanie cyklem życia danych i zarządzanie rekordami

- [Zakresy adaptacyjne](retention.md#adaptive-or-static-policy-scopes-for-retention) zasad przechowywania i zasad etykiet przechowywania są teraz ogólnie dostępne(GA). Instrukcje [dotyczące konfigurowania zakresu adaptacyjnego](retention-settings.md#to-configure-an-adaptive-scope) zawierają teraz więcej informacji na temat zakresów witryn programu SharePoint: dokumentacja wpisu w blogu dotycząca używania właściwości witryny niestandardowej i sposobu używania właściwości witryny SiteTemplate do dołączania lub wykluczania określonych typów witryn za pomocą zaawansowanego konstruktora zapytań.
...
- Program PowerShell jest alternatywą dla ustawienia zarządzania rekordami, które umożliwia użytkownikom usuwanie elementów oznaczonych etykietami w programach SharePoint i OneDrive przy użyciu opcji AllowFilesWithKeepLabelToBeDeletedSPO i AllowFilesWithKeepLabelToBeDeletedODB z [funkcji Get-PnPTenant](https://pnp.github.io/powershell/cmdlets/Get-PnPTenant.html) i [Set-PnPTenant](https://pnp.github.io/powershell/cmdlets/Set-PnPTenant.html).

### <a name="sensitivity-labels"></a>Etykiety wrażliwości

- Nowe wskazówki [Dlaczego warto wybrać wbudowane etykietowanie w dodatku AIP dla aplikacji pakietu Office](sensitivity-labels-aip.md), jeśli używasz klienta ujednoliconego etykietowania usługi Azure Information Protection (AIP) dla komputerów z systemem Windows. Ta strona zawiera informacje o nowej prywatnej wersji zapoznawczej dla aplikacji pakietu Office.
...
- Obsługa ustawiania domyślnego typu łącza udostępniania jest rozszerzona na poszczególne dokumenty w programach SharePoint i OneDrive. Aby uzyskać więcej informacji, zobacz nowy artykuł [Używanie etykiet poufności do konfigurowania domyślnego typu łącza udostępniania dla witryn i dokumentów w programach SharePoint i OneDrive]( sensitivity-labels-default-sharing-link.md).
- Centrum administracyjne usługi Teams obsługuje teraz etykiety kontenerów (etykiety poufności z zakresem grup & lokacji).
...
- [Wprowadzenie do zarządzania cyklem życia danych](get-started-with-data-lifecycle-management.md) — nowe, aby zastąpić element "Wprowadzenie do przechowywania", ten artykuł zawiera kroki wprowadzające dla wszystkich funkcji zarządzania cyklem życia danych, które obejmują przechowywanie.
...
- Ogłoszono w lipcu Semi-Annual Enterprise Channel w wersji 2202+: Współtworzenie i inspekcja dla programu Outlook.

## <a name="december-2021"></a>Grudzień 2021

### <a name="compliance-and-service-assurance"></a>Zgodność i gwarancja usługi

- [Powiadomienie o naruszeniach zabezpieczeń platformy Azure, dynamics 365 i systemu Windows w ramach RODO](/compliance/regulatory/gdpr-breach-notification) — zaktualizowane w celu wyjaśnienia, że klienci nie muszą korzystać z usługi płatnej, takiej jak Defender for Cloud, aby otrzymywać powiadomienia o zabezpieczeniach i ochronie prywatności

### <a name="ediscovery"></a>Zbierania elektronicznych materiałów dowodowych

- [Przepływ pracy zbierania elektronicznych materiałów dowodowych (Premium) dla zawartości w usłudze Microsoft Teams](teams-workflow-in-advanced-ediscovery.md#reference-guide) — zaktualizowany o nowy przewodnik szybkiego odwołania do pobrania do zarządzania zawartością usługi Teams w środowisku zbierania elektronicznych materiałów dowodowych (Premium)
...
- [Importowanie plików PST organizacji do platformy Microsoft 365](use-network-upload-to-import-pst-files.md#step-2-upload-your-pst-files-to-microsoft-365) — importowanie PST przy użyciu przekazywania sieci obsługuje teraz narzędzie AzCopy w wersji 10
...
- [Wdrażanie rozwiązania do ochrony informacji za pomocą usługi Microsoft Purview](information-protection-solution.md) — nowe wskazówki krok po kroku dla klientów poszukujących opisowego planu wdrażania Microsoft Purview Information Protection
...
- Wprowadzanie nowych ustawień dzierżawy: ustawienie zarządzania rekordami, które uniemożliwia edytowanie właściwości elementów programu SharePoint oznaczonych etykietami, które są oznaczone jako rekord i zablokowane, oraz inne ustawienie uniemożliwiające użytkownikom odblokowywanie elementów oznaczonych jako rekord

### <a name="sensitivity-labels"></a>Etykiety wrażliwości

- Obowiązkowe etykietowanie i etykieta domyślna usługi Power BI są teraz ogólnie dostępne (GA)
