---
title: Co nowego w rozwiązaniach dotyczących ryzyka i zgodności Microsoft Purview
f1.keywords:
- NOCSH
...
ms.locfileid: "66089931"
---
# <a name="whats-new-in-microsoft-purview-risk-and-compliance-solutions"></a>Co nowego w rozwiązaniach dotyczących ryzyka i zgodności Microsoft Purview
...
- [Zasady zgodności komunikacji](communication-compliance-policies.md) — wyjaśnione komunikaty zgłaszane przez użytkowników wyłączają/włączają proces i objaśnione przetwarzanie dla Teams i Exchange.
...
- [Cykl życia opracowywania zabezpieczeń firmy Microsoft](/compliance/assurance/assurance-microsoft-security-development-lifecycle) — nowy temat zapewniania SDL dla usługi firmy Microsoft.
...
- [Dowiedz się więcej o barierach informacyjnych](information-barriers.md), [Wprowadzenie z barierami informacyjnymi](information-barriers-policies.md) — refaktoryzowana struktura tematów i dodano wyjaśnienie dotyczące Exchange Online wsparcia i ograniczeń, zaktualizowane w celu uwzględnienia obsługi nowego środowiska interfejsu użytkownika IB.

### <a name="insider-risk-management"></a>Zarządzanie ryzykiem wewnętrznym

- [Wprowadzenie z ustawieniami zarządzania ryzykiem wewnętrznym](insider-risk-management-settings.md) — dodano wskazówki dotyczące nowych wskaźników aplikacji Defender dla Chmury, nowej anomalii jako zdarzenia wyzwalającego w progach niestandardowych, nowej obsługi zasad priorytetyzacji rozszerzenia plików i etykiet poufności.
...
- [Dowiedz się więcej o bezpłatnej wersji próbnej Priva](/privacy/priva/priva-trial) — zaktualizowany link do nowych warunków i postanowień dotyczących wersji próbnej Microsoft 365 uniwersalnej oraz drobnych aktualizacji w celu wyjaśnienia ról i uprawnień.
- [Wprowadzenie z Priva](/privacy/priva/priva-setup) — dodano sekcję wskazującą ograniczenia Priva dostępności.
