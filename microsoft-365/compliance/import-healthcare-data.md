...
|Pole|Kategoria|
|:----|:----------|
| *Nazwa zdarzenia TimeEvent<br/>* tworzenia<br/>Identyfikator stacji roboczej<br/>Sekcja zdarzenia<br/>Kategoria zdarzenia |Te pola służą do identyfikowania zdarzeń działania dostępu w systemie EHR opieki zdrowotnej.|
| Identyfikator rejestru pacjentów<br/>Imię *<br/>pacjentaNazwa środkowa <br/>Pacjenta Nazwisko pacjenta* <br/>Adres pacjenta — wiersz 1* <br/>Adres pacjenta — wiersz 2<br/>Miasto pacjentów* <br/>Kod pocztowy pacjenta*  <br/>Stan pacjenta <br/>Kraj pacjenta <br/>Oddział pacjentów              | Te pola służą do identyfikowania informacji o profilu pacjenta.|
