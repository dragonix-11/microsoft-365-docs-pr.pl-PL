...
W poniższej tabeli wymieniono limity dotyczące blokad skojarzonych ze sprawą zbierania elektronicznych materiałów dowodowych (Premium).

| Opis limitu | Limit |
|:-----|:-----|
|Maksymalna liczba zasad blokady dla organizacji. Ten limit obejmuje łączną sumę zasad blokady w przypadkach Zbieranie elektronicznych materiałów dowodowych w Microsoft Purview (Standardowa) i Zbieranie elektronicznych materiałów dowodowych w Microsoft Purview (Premium). <br/> |10.000<sup>3</sup>  <br/> |
...
W poniższej tabeli wymieniono limity indeksowania w usłudze eDiscovery (Premium).
...
Limity opisane w tej sekcji są związane z używaniem narzędzia wyszukiwania na karcie **Wyszukiwania** w celu zbierania danych dla danego przypadku. Aby uzyskać więcej informacji, zobacz [Collect data for a case in eDiscovery (Premium) (Zbieranie danych dla przypadku w usłudze eDiscovery (Premium)](collecting-data-for-ediscovery.md)).
...
|Maksymalna liczba znaków zapytania wyszukiwania dla witryn programu SharePoint i OneDrive dla Firm (w tym operatorów i warunków).|10,000<br>4000 z symbolami wieloznaczymi<sup>5</sup>|
...
|Maksymalna liczba elementów z programu SharePoint i witryn OneDrive dla Firm wyświetlanych na stronie w wersji zapoznawczej w celu wyszukiwania. Zostaną wyświetlone najnowsze elementy.|200|
|Maksymalna liczba witryn programu SharePoint i OneDrive dla Firm, dla których można wyświetlić podgląd wyników wyszukiwania. Jeśli istnieje ponad 200 witryn, które zawierają elementy zgodne z zapytaniem wyszukiwania, tylko 200 pierwszych witryn z największą ilością wyników jest dostępnych w wersji zapoznawczej.|200|
