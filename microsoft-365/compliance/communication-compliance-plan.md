...
W przypadku organizacji korzystających z zasad nadzoru w Office 365 należy natychmiast zaplanować przejście do zasad zgodności komunikacji w usłudze Microsoft Purview i zrozumieć te ważne kwestie:
...
- Komunikatów zapisanych w nadzorze w Office 365 dopasowania zasad nie można przenosić ani udostępniać do zgodności z komunikacją.
...
Aby uzyskać informacje o wycofaniu nadzoru w Office 365, zobacz Plan działania platformy [Microsoft 365](https://www.microsoft.com/microsoft-365/roadmap), aby uzyskać szczegółowe informacje.
...
- Wszystkie organizacje mają różne standardy komunikacyjne i wymagania dotyczące zasad. Wykrywanie określonych słów kluczowych przy użyciu [warunków zasad](communication-compliance-policies.md#conditional-settings) zgodności komunikacji lub wykrywanie określonych typów informacji przy użyciu [niestandardowych typów informacji poufnych](create-a-custom-sensitive-information-type.md).
