...
4. Ponownie zastosować blokady usunięte w kroku 3. W zależności od typu blokady użyj jednej z poniższych procedur.
    ...
    **Zasady przechowywania w całej organizacji**
    ...
    Jeśli usunięto zasady przechowywania w całej organizacji lub w całej Exchange, wykluczając je z zasad, użyj portalu zgodności, aby usunąć skrzynkę pocztową z listy wykluczonych użytkowników. Przejdź do strony **Przechowywanie** **zarządzania cyklem** >  życia danych w Centrum zgodności, edytuj zasady przechowywania w całej organizacji i usuń skrzynkę pocztową z listy wykluczonych adresatów. Spowoduje to ponowne zastosowanie zasad przechowywania do skrzynki pocztowej użytkownika.
