...
32 | Domyślne<BR>Opcjonalny<BR>**Uwagi:** Usługa OneDrive dla Firm: możliwości obsługi, telemetria, interfejsy API i linki osadzone w wiadomościach e-mail | Nie | `*.log.optimizely.com, ssw.live.com, storage.live.com` | **TCP:** 443
...
29 | Domyślne<BR>Opcjonalny<BR>**Uwagi:** Integracja usługi Yammer z rozwiązaniami innych dostawców | Nie | `*.tenor.com` | **TCP:** 443, 80
...
52 | Domyślne<BR>Opcjonalny<BR>**Uwagi:** Sieci CDN i usługi pomocnicze innych firm dla programu OneNote | Nie | `s.ytimg.com, www.youtube.com` | **TCP:** 443
...
110 | Domyślne<BR>Opcjonalny<BR>**Uwagi:** Outlook dla systemów Android i iOS: dostosowywanie integracji | Nie | `app.adjust.com` | **TCP:** 443
