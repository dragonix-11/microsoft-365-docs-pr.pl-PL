...
|3|**Połączenie usługi Azure AD (opcja w/SSO)** <p> WinRM & zdalnego programu PowerShell|Porty TCP środowiska sts klienta (serwer usług AD FS i serwer proxy usług AD FS) \| 80 & 443|Ruch przychodzący serwera|
...
|10|**Usługa AutoWykrywanie** jest używana w [scenariuszach hybrydowych Exchange](/exchange/exchange-deployment-assistant) z [nowoczesnym uwierzytelnianiem hybrydowym z Outlook dla systemów iOS i Android](/Exchange/clients/outlook-for-ios-and-android/use-hybrid-modern-auth) <p> `*.acompli.net` <br> `*.outlookmobile.com` <br> `*.outlookmobile.us` <br> `52.125.128.0/20` <br> `52.127.96.0/23`|Lokalny serwer Exchange klienta na serwerze TCP 443|Ruch przychodzący serwera|
|11|**Exchange uwierzytelnianie hybrydowe usługi Azure AD**|*.msappproxy.net|Ruch wychodzący protokołu TCP tylko na serwerze|
