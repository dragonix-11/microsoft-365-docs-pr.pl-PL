...
| Typ wniosku o pomoc techniczną | Kiedy używać |
| ----- | ----- |
...
1. Zaloguj się w [Microsoft Endpoint Manager](https://endpoint.microsoft.com/) i przejdź do menu **Administracja dzierżawą**.
1. W sekcji **Żądania obsługi** użyj paska wyszukiwania lub filtrów, aby znaleźć sprawę, którą chcesz edytować.
1. Wybierz sprawę, aby otworzyć szczegóły wniosku.
1. Przewiń do dołu szczegółów żądania i wybierz pozycję **Edytuj**.
1. Zaktualizuj edytowalne informacje, dodaj załączniki do sprawy lub dodaj notatkę dla zespołu inżynierów serwisowych.
1. Wybierz **Zapisz**.
...
Gdy jesteś podstawowym kontaktem w sprawie wniosku o pomoc techniczną, otrzymasz wiadomość e-mail od osoby Microsoft Managed Desktop-mail. Po tym, jak problem zostanie rozwiązany, w wiadomości e-mail zostanie zadane pytanie o jego środowisko. Opinie są aktywnie monitorowane i udostępniane inżynierom w celu ulepszania usługi i ustalania priorytetów przyszłych funkcji. Pamiętaj, aby skoncentrować się na swoim doświadczeniu i nie dołączać informacji osobistych w formularzu opinii. Aby uzyskać więcej informacji o ochronie prywatności, zobacz [Oświadczenie o ochronie prywatności firmy Microsoft](https://privacy.microsoft.com/privacystatement).

## <a name="support-request-severity-definitions"></a>Definicje ważności wniosku o pomoc techniczną

Początkowy czas odpowiedzi to okres od momentu zgłoszenia do pomocy technicznej do momentu, Microsoft Managed Desktop kontaktu z Tobą, i rozpoczęcie pracy nad zgłoszeniem do pomocy technicznej. Czas pierwszej odpowiedzi różni się w zależności od wpływu biznesowego żądania. Jego ważność zależy od ważności żądania.

> [!NOTE]
> W tej tabeli "godziny pomocy technicznej dla administratorów" oznacza, że Microsoft Managed Desktop pomocy technicznej dla administratorów jest dostępna w większości krajów przez 24 godziny dziennie od poniedziałku do **piątku**. Ważność Problemy mogą być przepracowane 24 godziny na dobę przez siedem dni w tygodniu.

| Poziom ważności | Sytuacja | Czas reakcji wstępnej | Oczekiwana odpowiedź od Ciebie |
| ----- | ----- |----- | ----- |
| **Ważność A: krytyczny <br> wpływ** | **Krytyczny wpływ na działalność biznesową** <br>Twoja firma utraciła lub pogorszenie wydajności usług i wymaga natychmiastowej uwagi.<p>**Główny wpływ na zgodność aplikacji**<br>W całej firmie występują skutki finansowe z powodu tego, że urządzenia nie reagują na nie ani nie utraciły krytycznej funkcjonalności. | **Inicjał:** < 1 godzinę <p> **Aktualizacja**: 60 minut <br> Dostępna jest 24-godzinna pomoc techniczna każdego dnia.</p> | Po wybraniu ważności A należy potwierdzić, że problem ma krytyczny wpływ na działalność biznesową, a proces ten może spowodować poważne utratę i pogorszenie wydajności usług. <br><br> Problem wymaga natychmiastowej odpowiedzi i zobowiązujesz się każdego dnia do ciągłego angażowania się w zespole firmy Microsoft do czasu rozwiązania problemu. W przeciwnym razie firma Microsoft może według własnego uznania zmniejszyć poziom Ważności do poziomu B.<br><br> Ponadto upewnij się, że firma Microsoft ma prawidłowe informacje kontaktowe.
**Ważność B: Umiarkowany <br> wpływ** | **Umiarkowany wpływ na działalność biznesową**<br>Twoja firma może po umiarkowanej utracie lub pogorszeniu usług, ale praca może być w uzasadniony sposób kontynuowana w sposób zakłócony.<p>**Umiarkowany wpływ na zgodność aplikacji**<br>Określone grupy biznesowe nie są już produktywne ze względu na brak reakcji urządzeń lub utratę krytycznej funkcjonalności.| **Wartość** początkowa: < 4 godziny. <p> **Aktualizacja**: 12 godzin; 24 godziny na dobę w godzinach pomocy technicznej dla administratorów (od poniedziałku do piątku).| Po wybraniu ważności B potwierdzisz, że problem ma umiarkowany wpływ na Twoją firmę ze stratą i obniżeniem poziomu usług. Jednak obejścia umożliwiają rozsądną, tymczasową i ciągłość działania. <br><br> Ten problem wymaga pilnej odpowiedzi. Jeśli po *przesłaniu wniosku* o pomoc techniczną wybierzesz wsparcie każdego dnia, zobowiązujesz się do ciągłego angażowania się każdego dnia z zespołem firmy Microsoft do czasu rozwiązania problemu. W przeciwnym razie firma Microsoft według własnego uznania może zmniejszyć ważność do poziomu C. Jeśli po *przesłaniu zgłoszenia do pomocy* technicznej dla administratora wybierzesz opcję Pomoc techniczna w godzinach pracy administratora, firma Microsoft skontaktuje się z Tobą tylko w godzinach pomocy technicznej dla administratorów.<br><br>Ponadto upewnij się, że firma Microsoft ma prawidłowe informacje kontaktowe.
**Ważność C: <br> minimalny wpływ** | **Minimalny wpływ na działalność biznesową**<br> Twoja firma działa z niewielkimi utrudnieniami w  świadczenie usług.<p>**Nieznaczny wpływ na zgodność aplikacji**<br>Potencjalnie niepowiązani użytkownicy mogą doświadczać drobnych problemów ze zgodnością, które uniemożliwiają produktywną pracę. | **Inicjał**: < 8 godzin.<p> **Aktualizacja**: 24 godziny; Pomoc techniczna 24 godziny na dobę w godzinach pomocy technicznej dla administratorów (od poniedziałku do piątku). | Po wybraniu ważności C potwierdzisz, że problem ma minimalny wpływ na Twoją firmę, jeśli nie masz niewielkiej przeszkód w  związku z usługą.<br><br> W przypadku zdarzenia o ważności C firma Microsoft skontaktuje się z Tobą tylko w godzinach pomocy technicznej dla administratorów.<br><br> Ponadto upewnij się, że firma Microsoft ma prawidłowe informacje kontaktowe.
